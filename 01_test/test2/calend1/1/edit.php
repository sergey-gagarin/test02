...
<tr>
      <td align="center" valign="middle"><form action="proc.php?edit=1" method="post" enctype="multipart/form-data" name="form1" target="_self">
...
<table width="276" border="0" cellpadding="0" cellspacing="0" class="table">
<tr>
                    <td width="300" align="center" valign="middle">
<table width="276" border="0" cellpadding="6" cellspacing="0" bgcolor="#000000">
                        <tr> 
                          <td width="92" align="right" valign="top" bgcolor="#333333"><strong><font color="#FFFFFF" size="2" face="Verdana">FILENAME:</font></strong></td>
                          <td width="160" bgcolor="#333333"><?php echo "$note"; ?></td>
                        </tr>
                        <tr align="center"> 
<td colspan="2" valign="top" bgcolor="#333333"> 
<textarea name="contents" cols="45" rows="7" class="input" id="contents">
<?php 
include("$note"); 
?></textarea>
                          </td>
                        ...
                        <tr align="center" bgcolor="#333333"> 
                          <td colspan="2" valign="top"><font color="#000000"> 
                            <input name="edit" type="submit" class="button" id="edit" value="Save Edit">
                            <input name="note" type="hidden" id="note" value="<?php echo "$note"; ?>">
                            </font></td>
                        </tr>
                      </table></td>
                  </tr>
          ...
          <font color="#999999" size="1" face="Verdana">Copyright &copy;2002 NeoSites.com. All rights reserved.</font> 
        </form></td>
    </tr>
  </table>
</div>

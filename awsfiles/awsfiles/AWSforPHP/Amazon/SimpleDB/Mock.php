...
class  Amazon_SimpleDB_Mock implements Amazon_SimpleDB_Interface
{
     ...
     * @param mixed $request array of parameters for Amazon_SimpleDB_Model_Query request or Amazon_SimpleDB_Model_Query object itself
     ...
     * @param mixed $request array of parameters for Amazon_SimpleDB_Model_QueryWithAttributes request or Amazon_SimpleDB_Model_QueryWithAttributes object itself
    ...
    public function queryWithAttributes($request) 
    {
        ...
        return Amazon_SimpleDB_Model_QueryWithAttributesResponse::fromXML($this->_invoke('QueryWithAttributes'));
    }
